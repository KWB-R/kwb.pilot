...
thresholds <- kwb.pilot::get_thresholds(csv_path = thresholds_file )

if (params$run_as_standalone) {
  
### Raw data
raw_dat <- kwb.pilot::import_data_berlin_s()

calc_dat <- kwb.pilot::calculate_operational_parameters_berlin_s(df = raw_dat)
